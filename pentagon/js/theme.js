...
(function ($) {
    ...
    $('#bottom-form').submit(function (e) {
        ...
        $.ajax({
            ...
            $(".form-result").addClass("alert").html("Спасибо. Ваш email успешно добавлен в список.");
        }).fail(function () {
            $(".form-result").addClass("alert").html("Ошибка. Данные не отправлены.");
        });
        e.preventDefault();
    });

    $(function () {
        $("[name='q_phone']").mask("+38(999) 999-99-99");
    });
